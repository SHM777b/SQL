...
CREATE TABLE students(
	...
	graduation_year DATE CHECK(graduation_year > '2023-06-01')
);
...
The constraints are mostly up to you, but your table constraints do have to consider the 
following:
...
phone number of 777-555-1234 and doesn't have an email. He graduates in 2035-01-01 and has 5 as a 
homeroom number.
*/
...
from the Biology department. His contact info is: jsalk@school.org and a phone number of 
777-555-4321.
*/
